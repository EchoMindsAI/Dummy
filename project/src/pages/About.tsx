    ...
    <div className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold text-white mb-6">About ECHOMINDS</h1>
        ...
        {/* Team Section */}
        <div>
          <h2 className="text-3xl font-bold text-white text-center mb-12">Our Founders</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              ...
              <div key={index} className="bg-black/20 backdrop-blur-lg p-6 rounded-lg text-center">
                <div className="w-32 h-32 rounded-full mx-auto mb-4 bg-gradient-to-br from-violet-400/20 to-purple-600/20 flex items-center justify-center">
